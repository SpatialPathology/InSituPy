...
def read_transcripts(self, *args, **kwargs):
    """Deprecated. Use ``load_transcripts`` instead."""
...
def read_xenium(self, *args, **kwargs):
    """Deprecated. Use ``read(mode='xenium')`` instead."""
...
def normalize_and_transform(self, *args, **kwargs):
    """Deprecated. Use ``insitupy.preprocessing.normalize_and_transform()`` instead."""
...
def reduce_dimensions(self, *args, **kwargs):
    """Deprecated. Use ``insitupy.preprocessing.reduce_dimensions()`` and ``insitupy.preprocessing.cluster_cells()`` instead."""
...
def save_current_colorlegend(self, *args, **kwargs):
    """Deprecated. Use ``.save_colorlegends()`` instead."""
...
def add_alt(self, *args, **kwargs):
    """Deprecated. Use ``.cells.add_*()`` instead."""
...
def store_geometries(self, *args, **kwargs):
    """Deprecated. Use ``sync_geometries()`` or the 'Sync Geometries' button in the napari viewer instead."""
...
def sync_geometries(self, *args, **kwargs):
    """Deprecated. Use the standalone ``sync_geometries()`` function or the 'Sync Geometries' button in the napari viewer instead."""
...
def save_colorlegends(self, *args, **kwargs):
    """Deprecated. Use the standalone ``save_colorlegends()`` function or the 'Save Colorlegends' button in the napari viewer instead."""
