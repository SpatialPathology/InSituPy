...
def pseudobulk_annotation(
    ...
    ``.units[units_key]``.
    Args:
        data (InSituData): Sample-level data object containing cells and
            annotations.
    ...
    Returns:
        InSituData: The same object, with ``.units[units_key]`` added if
        at least one object had both a pseudobulk and a polygon.
    """
