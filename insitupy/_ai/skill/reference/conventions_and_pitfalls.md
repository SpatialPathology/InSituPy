<!-- AUTO-GENERATED by tools/generate_skill_reference.py from .claude/skills/insitupy-pitfalls/reference/conventions_and_pitfalls.md (insitupy v0.12.0b8) - do not edit here; edit the source and re-run the generator. -->
