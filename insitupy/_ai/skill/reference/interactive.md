<!-- AUTO-GENERATED by tools/generate_skill_reference.py from mcp_server.server.get_interactive_guide() (insitupy v0.12.0b8) - do not edit here; edit the source and re-run the generator. -->
...
## data.show() — Launch napari viewer
  ...
  ... [truncated — full text is 941 chars]
...
... [truncated — full text is 4213 chars]
