<!-- AUTO-GENERATED by tools/generate_skill_reference.py from mcp_server.server.get_workflow_guide() (insitupy v0.12.0b7) - do not edit here; edit the source and re-run the generator. -->
