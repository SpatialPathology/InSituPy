<!-- AUTO-GENERATED from .claude/skills/insitupy/references/conventions_and_pitfalls.md by tools/sync_commands.py - do not edit here; edit the canonical file and re-run the sync. -->
