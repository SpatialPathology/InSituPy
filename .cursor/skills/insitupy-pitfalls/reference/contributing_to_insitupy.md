<!-- AUTO-GENERATED from .claude/skills/insitupy-pitfalls/reference/contributing_to_insitupy.md by tools/sync_commands.py - do not edit here; edit the canonical file and re-run the sync. -->
